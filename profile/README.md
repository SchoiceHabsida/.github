...
### :hammer_and_wrench: Что мы используем :
...
---
Если ты работаешь над одним из проектов и у тебя нет доступа к репозиторию, обратись за помощью к [@kimmik8🧛](https://github.com/kimmik8)
...
Если ты на **front-end** части проекта, по всем ~~неглупым~~ вопросам можно обратиться к [@Alyona275🦋](https://github.com/Alyona275)

Если же ты отвечаешь за **back-end** разработку обратиться по всем возникшим вопросам можно к [@kimmik8🧛](https://github.com/kimmik8)
